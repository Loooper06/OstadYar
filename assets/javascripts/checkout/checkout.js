...
// Have Account Animate
let LoginContent = document.getElementById('content-container');
let CouponContent = document.getElementById('coupon-content');

function ShowDetails(){
    LoginContent.classList.toggle('animate-login');
}

function ShowDetails2(){
    CouponContent.classList.toggle('animate-login');
}
