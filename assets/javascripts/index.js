...
const OwlNext = document.getElementById('owl-next');
const OwlPrev = document.getElementById('owl-prev');

OwlNext.addEventListener('click', function(){
    OwlNext.style.width = '2rem';
    OwlNext.style.backgroundColor = '#26A69A';
    OwlPrev.style.width = '.8rem';
    OwlPrev.style.backgroundColor = '#d1d1d1';
})

OwlPrev.addEventListener('click', function(){
    OwlPrev.style.width = '2rem';
    OwlPrev.style.backgroundColor = '#26A69A';
    OwlNext.style.width = '.8rem';
    OwlNext.style.backgroundColor = '#d1d1d1';
})
